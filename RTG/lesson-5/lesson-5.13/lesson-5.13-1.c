/*
 * Listing 5.13-1 Traditional Daemon demonstration
 * 
 * This program does the following:
 *   - initializes the process as a daemon (the old fashion way)
 ...
 * 
 * 1. compile the program gcc -ggdb lesson-5.13-2.c -o signal_daemon
 * 2. open a new terminal and run  - tail -f /var/log/syslog
 * 3. run the program, from the previous terminal ./signal_daemon
...
int main()
{
        ...
        */
        ...
        while (1)
        {
            syslog(LOG_INFO, "daemon is still alive \n");
